...
- TypeScript/JavaScript: Node.js, NestJS, Express, Fastify, Jest, Playwright 

- Front-End: React, Angular, Astro 

- Banco de dados: PostgreSQL, MySQL, SQLite, MongoDB 

- Nuvem e Infraestrutura: AWS, Cloudflare, Firebase, DigitalOcean, Hetzner, Linux, Nginx, Caddy 

- DevOps & Ferramentas: Git, GitHub Actions, Docker, Terraform, PM2, Postman
